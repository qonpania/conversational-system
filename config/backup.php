...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => "conversational-agent/backups",
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'sharvel.irigoyen@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'sharvel.irigoyen@gmail.com'),
                'name' => env('MAIL_FROM_NAME', 'Conversational agent backup'),
            ],
        ],
